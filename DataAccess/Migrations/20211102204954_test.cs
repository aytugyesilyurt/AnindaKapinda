    ...
    public partial class test : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "İçecek" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "FirstName", "IsActive", "LastName", "Mail", "Password", "ValidationCode" },
                values: new object[] { 1, "Aytuğ", true, "Yeşilyurt", "yesilyurt.aytug@hotmail.com", "aytug123", null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "Description", "DiscountedPrice", "Name", "Price" },
                values: new object[] { 1, 1, "su", null, "su", 1m });
